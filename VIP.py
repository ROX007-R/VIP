...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/ROX007-R/Lisence/blob/main/Lisence.txt"])
	exit(" [*] FACEBOOK : https://www.facebook.com/hecker.bo?mibextid=ZbWKwL ")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ MESSENGER🔰🥰https://m.me/hecker.bo?mibextid=ZbWKwL")
	subprocess.check_output(["am", "start", "https://m.me/hecker.bo?mibextid=ZbWKwL"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/ROX007-R/Lisence/blob/main/Lisence.txt').text
			if basesplit in plr:
				key = basesplit
			...
			exit()
		os.system("clear")
		os.system("xdg-open \'https://www.facebook.com/hecker.bo?mibextid=ZbWKwL\'")
		
		print ("""\033[1;92m

\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : MR RAKIB/Ariyan Islam ashraful
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : COMINH SOON
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : COMINH SOON
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mWARNING  : IT'S A BRAND
\033[1;90m══════════════════════════════════════════════════
    """)
		print("%s [%s•%s] %sTOOL NAME : %sARIAN/ASHRAFUL❌ PRO CLONER❌"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [RAKIB] : %s/%s -> \033[0;92m [  VIP-OK:%s ]- \033[0;91m[OPS-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
